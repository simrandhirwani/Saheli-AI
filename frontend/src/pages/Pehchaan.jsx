  ...
  const dataBundle = {
    en: {
      ...
      helpers: [
        ...
        { name: "Adv. Anjali Sharma", city: "Mumbai", type: "Legal Advocate", badge: "Professional", desc: "Free legal evaluation mapping under BNS Sections 85–86 and PWDVA family protection laws.", phone: "Hidden", email: "Contact via App" },
    ...
    hi: {
      ...
      helpers: [
        ...
        { name: "एडवोकेट अंजली शर्मा", city: "Mumbai", type: "कानूनी अधिवक्ता", badge: "प्रोफेशनल", desc: "BNS धारा 85–86 और PWDVA पारिवारिक संरक्षण कानूनों के तहत मुफ्त कानूनी मूल्यांकन।", phone: "Hidden", email: "Contact via App" },
    ...
    gu: {
      ...
      helpers: [
        ...
        { name: "એડવોકેટ અંજલી શર્મા", city: "Mumbai", type: "કાનૂની એડવોકેટ", badge: "પ્રોફેશનલ", desc: "BNS કલમ 85–86 અને PWDVA પરિવાર સુરક્ષા કાયદા હેઠળ મફત કાનૂની માર્ગદર્શન.", phone: "Hidden", email: "Contact via App" },
    ...
    mr: {
      ...
      helpers: [
        ...
        { name: "एडव्होकेट अंजली शर्मा", city: "Mumbai", type: "कायदेशीर वकील", badge: "प्रोफेशनल", desc: "BNS कलम 85–86 आणि PWDVA कौटुंबिक संरक्षण कायद्यांतर्गत विनामूल्य कायदेशीर मूल्यमापन.", phone: "Hidden", email: "Contact via App" },
