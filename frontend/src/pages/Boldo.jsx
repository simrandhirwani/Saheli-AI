...
export default function Boldo() {
  ...
  const content = {
    en: {
      ...
      legalRef: "References: current BNS provisions selected for the facts described, such as BNS Sections 85 & 86 (cruelty by husband/relatives), PWDVA Act 2005, and other applicable Indian laws",
    ...
    gu: {
      ...
      legalRef: "સંદર્ભ: તમારા લખેલા તથ્યો માટે પસંદ કરેલી વર્તમાન BNS કલમો, જેમ કે BNS કલમ 85 અને 86 (પતિ/પરિવાર દ્વારા તંગદિલી), PWDVA ધારો 2005, અને જરૂરી હોય તો અન્ય હાલના ભારતીય કાયદા",
    ...
    mr: {
      ...
      legalRef: "संदर्भ: आपके बताए गए तथ्यों के अनुसार चुनी गई वर्तमान BNS धाराएँ, जैसे BNS धारा 85 और 86 (पति/परिवार द्वारा शोषण), PWDVA अधिनियम 2005, और आवश्यकतानुसार अन्य वर्तमान भारतीय कानून",
